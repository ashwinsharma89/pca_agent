...
class CampaignRepository(BaseRepository):
    ...
    def search(self, filters: Dict[str, Any], limit: int = 100) -> List[Campaign]:
        ...
        if 'platform' in filters:
            query = query.filter(Campaign.platform == filters['platform'])
    ...
    def get_aggregated_metrics(self, filters: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        query = self.session.query(
            ...
            func.avg(Campaign.ctr).label('avg_ctr'),
            func.avg(Campaign.cpc).label('avg_cpc'),
            func.avg(Campaign.cpa).label('avg_cpa'),
        ...
        return {
            ...
            'avg_cpc': float(result.avg_cpc or 0),

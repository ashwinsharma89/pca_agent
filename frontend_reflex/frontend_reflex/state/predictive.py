...
class PredictiveState(DataState):
    ...
    def run_prediction(self):
        ...
        if not BACKEND_AVAILABLE:
            return rx.window_alert("Predictive backend not available.")
        ...
        try:
            ...
            return rx.window_alert(f"Prediction Error: {e}")
        finally:
    ...
    def run_optimization(self):
        ...
        if not hasattr(self, "_df") or self._df is None:
             return rx.window_alert("Please upload historical data first.")
        ...
        try:
            ...
            self.optimization_result['chart_values'] = [x['recommended_budget'] for x in result['allocation'].values()]
             ...
             return rx.window_alert(f"Optimization Error: {e}")
        finally:
    ...
    def train_model(self):
        ...
        try:
            ...
            return rx.window_alert(f"Training Error: {e}")
        finally:
